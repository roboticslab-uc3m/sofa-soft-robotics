...
def createScene(rootNode):
    ...
    Cosseratcable(FEMpos=FEMpos,parentNode=Cables,attachTo=finger,cosseratGeometry=beamGeometry,radius=0.5,name="1")
 
    FEMpos2 = [" 10 0 0 25 0 0 40 0 0 55 0 0 70 0 0 76 0 0 91 0 0"]
    beamGeometry2 = {'init_pos': [10., 0., 0.], 'tot_length': 81, 'nbSectionS': 12,
            'nbFramesF': 30, 'buildCollisionModel': 0, 'beamMass': 0.}
    
    Cosseratcable(FEMpos=FEMpos2,parentNode=Cables,attachTo=finger,cosseratGeometry=beamGeometry2,radius=0.5,name="2")
