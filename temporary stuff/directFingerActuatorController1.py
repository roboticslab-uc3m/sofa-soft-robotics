...
def Cosseratcable(parentNode=None,attachTo=None,FEMpos=[],name="1",
    ...
    cosserat = cableNode.addChild(Cosserat(parent=cableNode, cosseratGeometry=cosseratGeometry, radius=0.5,
                                           useCollisionModel=useCollisionModel, name="cosserat", youngModulus=youngModulus, poissonRatio=poissonRatio, translation=cosseratGeometry["init_pos"],rotation=rotation))
    # if name=="2":
...
def createScene(rootNode):
    ...
    finger =Finger(rootNode,translation=[2,-2.5,7.5],rotation=[0.0, 180.0, 90.0],fixingBox=[-8 ,-5 ,-8 ,7, 7 ,8])
    ...
    FEMpos = [" -10 10 0 -10 25 0 -10 40 0 -10 55 0 -10 70 0 -10 76 0 -10 91 0"]
    ...
    FEMpos2 = [" 0 10 0 0 25 0 0 40 0 0 55 0 0 70 0 0 76 0 0 91 0"]
    beamGeometry2 = {'init_pos': [0., 10., 0.], 'tot_length': 81, 'nbSectionS': 12,
            'nbFramesF': 30, 'buildCollisionModel': 0, 'beamMass': 0.}
