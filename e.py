...
femPos = [" 17.5 12.5 0 32.5 12.5 0 47.5 12.5 0 62.5 12.5 0 77.5 12.5 0 83.5 12.5 0 98.5 12.5 0.0"]
...
def createScene(rootNode):
    ...
    fingerNode, femPointsNode = Finger(femFingerNode, name="Finger", rotation=[0.0, 180.0, 0.0],fixingBox=[-1,-2.5,-8,19.5,9.5,8],
                                       translation=[0.0, 0, 7.5], path='')
    """ 
        Add Cosserat cable to the scene
    """
    beamGeometrie = {'init_pos': [17.5, 12.5, 0.], 'tot_length': 81, 'nbSectionS': 12,
